...
import myFormPTrapecioStyle from "./my-form-p-trapecioStyle";

export class MyFormPTrapecio extends LitElement{
    static get styles(){
        return [myFormPTrapecioStyle]
    }
    static properties = {
        lado: {
            type: Number
...
customElements.define('my-form-p-trapecio', MyFormPTrapecio)